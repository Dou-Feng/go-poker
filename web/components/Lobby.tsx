    ...
    return (
        <div className="flex min-h-screen flex-col">
            ...
            <div className="flex flex-grow flex-col items-center px-4">
                <h1 className="mb-8 mt-4 text-4xl font-semibold text-white">{t("lobby")}</h1>
                ...
                <div className="mb-4 flex w-full max-w-md flex-col gap-2">
                    ...
                    <div className="flex flex-row flex-wrap items-center gap-2 rounded-sm bg-neutral-800 px-3 py-2 text-xs">
                        ...
                        <input
                            ...
                            min={1}
                            value={maxBuyIns}
                            onChange={(e) => setMaxBuyIns(Math.max(1, Number(e.target.value)))}
                ...
                <div className="flex w-full max-w-md flex-col gap-4">                    <div className="flex flex-col gap-2">
