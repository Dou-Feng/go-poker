...
func (c *Client) processEvents(rawMessage []byte) error {
	...
	case actionCreateTable:
		...
		handleCreateTable(c, table.Tablename, table.Password, table.SB, table.BB, table.BuyIn, table.MaxBuy, table.MaxPlayers, table.HandsLimit, table.Tournament, table.ActionTimeout, table.BotType)
		return nil
